...
class AddSyllabusDesktop extends StatefulWidget {
  const AddSyllabusDesktop({super.key});

  @override
  State<AddSyllabusDesktop> createState() => _AddSyllabusDesktopState();
}

class _AddSyllabusDesktopState extends State<AddSyllabusDesktop> {
                ...
                Card(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text("   Syllabus Info", style: DFont.subTitle),
                        Divider(
                          thickness: 1,
                          indent: 10,
                          endIndent: 10,
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  DropDownInput(
                                    label: "Regulations",
                                    items: HelperFunctions.regulations,
                                    onChanged: (p0) {},
                                  ),
                                  SizedBox(height: DSizes.sm),
