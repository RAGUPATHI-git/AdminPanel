  ...
  Widget build(BuildContext context) {
    ...
    return BlocListener<AuthBloc, AuthState>(
      listener: (context, state) {
        if(state.toast == AuthenticationToast.success){
          DToast().successToast("Login success", context);
        }
      },
      child: Scaffold(
        body: Center(
                          ...
                          children: [
                            ...
                            BasicInput(
                              onChanged: (password) => authBloc
                                  .add(AuthPassword(password: password)),
                              error: state.showError && state.password.isEmpty
                                  ? state.eMessage
                                  : null,
                              label: "Password",
                              obscureText: obscure ? true : false,
